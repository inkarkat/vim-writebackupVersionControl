...
call vimtap#window#IsWindows(['important.txt.diff [Scratch1]', 'important.txt.diff', 'important.txt'], 'original, saved scratch and 2nd diff scratch buffer')
...
call vimtap#window#IsWindows(['important.txt.diff [Scratch2]', 'important2.txt.diff', 'important.txt.diff', 'important.txt'], 'original, two saved scratch and 3rd diff scratch buffer')
